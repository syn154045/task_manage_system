            ...
            <div class="w-1/2 flex justify-center">
                <div class="w-[85%] flex items-center p-2 border-b border-admin-text-sub hover:text-admin-text-subhover transition duration-500">
                    <a href="" class="jsMenuItems w-full hidden items-center relative">
                        ...
                        <div class="absolute -left-3 w-full h-10 bg-gradient-to-r from-admin-accent-type2 to-transparent opacity-50 rounded-full"></div>
                        @endif
                    </a>
                </div>
            </div>
            ...
            <div class="w-1/2 flex justify-center">
                <div class="w-[85%] flex items-center p-2 border-b border-admin-text-sub hover:text-admin-text-subhover transition duration-500">
                    <a href="" class="jsMenuItems w-full hidden items-center relative">
                        ...
                        <div class="absolute -left-3 w-full h-10 bg-gradient-to-t from-admin-accent-type2 to-transparent opacity-50 rounded-full"></div>
                        @endif
                    </a>
                </div>
            </div>
