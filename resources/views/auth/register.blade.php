<x-layouts.global title="SignUp">
    ...
    <div class="w-11/12 mx-auto bg-gray-100 flex items-center justify-center rounded-lg">
        <div class="w-4/5 max-w-screen-sm p-6">
            ...
            <h1 class="text-sm font-semibold mb-6 text-gray-500 text-center">Join to our community and exchange informations about birds!</h1>
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="username" name="name" value="{{ old('name') }}" class="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300">
                    @error('name')
                    <div class="text-xs relative block w-full rounded-lg tex-red-700 opacity-100">
            ...
            <div class="mt-4 text-sm text-gray-600 text-center">
                <p>
                    ...
                    <a href="{{ route('login') }}" class="text-green-600 rounded-md hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-700">
                        Sign in here
                    </a>
                </p>
            </div>
